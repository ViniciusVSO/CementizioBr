...
export default function Product() {
    ...
    return (
      <div className="bg-white w-full" id="sobre">
        <div className="text-black max-w-[1280px] h-full gap-16 mx-auto flex flex-col justify-between px-6 py-28">
          ...
          <div className="flex w-full justify-between gap-6">
            <div className="flex flex-col gap-8 min-w-[340px] min-h-auto">
              <div className="flex justify-between flex-col gap-2">
                <div className="">
                  <h2 className="text-4xl font-medium">
                    {products[selectedIndex].name}
                  </h2>
                  <span>Liso e etrusco/ cementicio e atérmico</span>
                </div>
              ...
              <p className="text-xl">{products[selectedIndex].description}</p>
              <Link href="">
            ...
            <div className="h-[500px] ">
              <div className="relative overflow-hidden h-[500px] min-w-full" ref={emblaRef}>
                <div className="flex transition-transform ease-out duration-300 gap-4">
                  {products.map((product, index) => (
                    <div
                      key={index}
                      className="min-w-full min-h-[500px flex items-center justify-center bg-gray-200"
                    >
                        <img src={product.picture} alt={`Imagem ${product.picture}`} />
                    </div>
                  ))}
                </div>
              </div>
